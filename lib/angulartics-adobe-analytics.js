      ...
      $analyticsProvider.registerEventTrack(function (action, properties) {
        if (window.s && action) {
          ...
          if (actionConfig) {
            ...
            if (properties.eventIds || actionConfig.eventIds) {
              properties.events = properties.eventIds || actionConfig.eventIds
              // TODO: Make actionConfig one analytics label to many or one id
              // eg. it'd be nice to be able to override eventIds and have it
              // stick to linkTrackEvents as well
              properties.linkTrackEvents = properties.eventIds || actionConfig.eventIds
            ...
            properties.linkTrackVars = linkTrackVars.join(',')
          }
